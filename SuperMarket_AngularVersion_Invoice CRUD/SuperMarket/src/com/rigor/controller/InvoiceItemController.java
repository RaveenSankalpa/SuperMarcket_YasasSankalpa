...
//	public ModelAndView loadInvoice() {
...
//	public ResponseEntity<InvoiceItem> getSingleInvoice(@PathVariable("invoiceID") int searchID) {
//		System.out.println("called service method iid is "+searchID);
//		InvoiceItem searchedItem = invoiceItemService.getInvoice(searchID);
//		return new ResponseEntity<InvoiceItem>(searchedItem, HttpStatus.OK);
//	}
