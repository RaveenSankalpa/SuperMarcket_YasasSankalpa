...
<html>
  ...
  <body ng-app="invoiceApp" class="ng-cloak">
...
<!--           <div class="panel panel-default"> -->
<!--           		<form ng-submit="ctrl.search()" name="searchForm"   > -->
<!--           		<input type="text" ng-model="ctrl.invoice.id" name="id" required="required" > -->
...
<!--           </div> -->
          ...
          <div class="formcontainer">
                  <form ng-submit="ctrl.search()" name="searchForm" class="form-horizontal">
                  </form>
          </div>
          ...
          <div class="panel panel-default">
              ...
              <div class="tablecontainer">
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="In in ctrl.invoices">
