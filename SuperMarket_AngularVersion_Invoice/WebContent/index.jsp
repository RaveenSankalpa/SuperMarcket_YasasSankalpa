			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			  <ul class="nav navbar-nav">
				...
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					<li> <a href="<c:url value='supplier.htm'/>">Add Supplier</a></li>
					<li> <a href="<c:url value='listSupplier.htm'/>">Supplier Search</a></li>
				  </ul>
				</li>
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					...
					<li> <a href="<c:url value='listInvoice'/>">Invoice Search</a></li>
				  </ul>
				</li>
				...
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					<li> <a href="<c:url value='addGrn.htm'/>">Place GRN</a></li>
					<li> <a href="<c:url value='listGrn.htm'/>">GRN Search</a></li>
				  </ul>
				</li>
